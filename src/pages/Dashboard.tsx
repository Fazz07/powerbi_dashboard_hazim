// src/pages/Dashboard.tsx
 import { useState, useEffect, useRef, useMemo, useCallback } from 'react'; 
  ...
  const Dashboard = () => {
    ...
    // REMOVED: const [chatbotCurrentWidth, setChatbotCurrentWidth] = useState(40); // NEW: State to store actual chatbot width
    ...
    return (
      <SidebarProvider>
        <div className="flex h-screen w-full overflow-hidden bg-background"> 
          ...
          {/* MODIFIED: SidebarInset now acts as the relative container for overlapping elements */}
          <SidebarInset className="relative flex-1 flex flex-col overflow-hidden">
            ...
            {/* Main content area, now takes full available width */}
            <main className="flex-1 overflow-hidden relative bg-background"> 
              ...
              {/* MODIFIED: EnhancedSidebar (Chart Library) is now placed here for absolute positioning */}
             <EnhancedSidebar
             ...
             <ChatbotPanel
               ...
               isDataLoading={isPbiDataCaching}
               // REMOVED: onWidthChange={setChatbotCurrentWidth}
             />
           </SidebarInset>
         </div>
         <ModalWindow
