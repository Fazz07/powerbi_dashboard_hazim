 ...
 const Login = () => {
   ...
   return (
     <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 via-white to-cyan-100 dark:from-gray-900 dark:via-gray-950 dark:to-gray-800 p-4">
       <Card className="w-full max-w-md shadow-xl rounded-xl"> {/* Added rounded-xl */}
         ...
         <form onSubmit={handleLogin}>
           <CardContent className="space-y-4">
             ...
             <Button type="submit" className="w-full rounded-md"> {/* Added rounded-md */}
               Sign In with Email
             </Button>
             ...
             <div className="grid grid-cols-3 gap-3">
               <Button
                 variant="outline"
                 className="w-full rounded-md" // Added rounded-md
               ...
               <Button
                 variant="outline"
                 className="w-full bg-blue-50 hover:bg-blue-100 dark:bg-blue-950 dark:hover:bg-blue-900 rounded-md" // Added rounded-md
